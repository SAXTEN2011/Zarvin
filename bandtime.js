...
function run(){
    ...
    if(currentTime>=730 && currentTime<=819){
        ...
        if(currentTime>=835 && currentTime<=839 && countdownRun == 1){
            countdown();
        }else {
        ...
        if(currentTime>=929 && currentTime<=933 && countdownRun == 1 /*933*/ ){
        countdown();
        }else {
        ...
        if (currentTime >= 1117 && currentTime <= 1122 && countdownRun == 1  /*933*/) {
            countdown();
        } else {
            if (end4 == currentHours) {
                timeLeft = 1207 - currentTime;
        ...
        if (currentTime >= 1211 && currentTime <= 1215 && countdownRun == 1  /*933*/) {
            countdown();
        } else {
            if (end5 == currentHours) {
                timeLeft = 1301 - currentTime;
        ...
        if (currentTime >= 1305 && currentTime <= 1309 && countdownRun == 1  /*933*/) {
            countdown();
        } else {
            if (end6 == currentHours) {
                timeLeft = 1355 - currentTime;
        ...
        if (currentTime >= 1359 && currentTime <= 1363 && countdownRun == 1  /*933*/) {
            countdown();
        } else {
            if (end7 == currentHours) {
                timeLeft = 1449 - currentTime;
...
//function for debugging for reachable code
function test(){
